...
export default function HomeSection() {
  ...
  return (
    <section id="home" className="relative h-screen min-h-[700px] w-full flex items-center justify-center text-center bg-background overflow-hidden pt-0 pb-16 md:pb-24">
