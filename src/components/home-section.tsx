...
export default function HomeSection() {
  ...
  return (
    <section id="home" className="relative h-[80vh] min-h-[600px] w-full flex items-center justify-center text-center bg-background overflow-hidden pt-8 md:pt-12 pb-12">
